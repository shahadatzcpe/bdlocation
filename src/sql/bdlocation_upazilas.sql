INSERT INTO `bdlocation_upazilas` (`id`, `district_id`, `name`, `bn_name`) VALUES
...
(232, 13, 'Kendua Upazila', 'কেন্দুয়া'),
(233, 13, 'Atpara Upazila', 'আটপাড়া'),
(234, 13, 'Barhatta Upazila', 'বরহাট্টা'),
(235, 13, 'Durgapur Upazila', 'দুর্গাপুর'),
(236, 13, 'Kalmakanda Upazila', 'কলমাকান্দা'),
(237, 13, 'Madan Upazila', 'মদন'),
(238, 13, 'Mohanganj Upazila', 'মোহনগঞ্জ'),
(239, 13, 'Netrakona-S Upazila', 'নেত্রকোনা সদর'),
(240, 13, 'Purbadhala Upazila', 'পূর্বধলা'),
(241, 13, 'Khaliajuri Upazila', 'খালিয়াজুরি'),
...
(319, 63, 'Narail-S Upazila', 'নড়াইল সদর'),
(320, 63, 'Lohagara Upazila', 'লোহাগাড়া'),
(321, 63, 'Kalia Upazila', 'কালিয়া'),
